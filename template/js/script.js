...
var stripe;
// var js_base_path = 'https://localhost/advs-payment/';
var js_base_path = 'https://'+location.hostname+'/';


// Disable the button until we have Stripe set up on the page
// document.querySelector("button").disabled = true;

fetch(js_base_path+ "transactions/config")
...
var orderData = {
  items: [{ id: "photo" , description:  description, price: price }]
};


  fetch(js_base_path+ "transactions/create_payment_intent", {
    method: "POST",
    headers: {
...
var orderComplete = function(clientSecret) {
  stripe.retrievePaymentIntent(clientSecret).then(function(result) {
    ...
    formdata.append("jsondata", paymentIntentJson);
    email = document.querySelector('input[name="email"]').value
    formdata.append("email", email);
    formdata.append("updatestripepayment", 'pending');
     id = document.querySelector('input[name="id"]').value,
    fetch(js_base_path+ "transactions/updatepayment/"+id+"" , {
      method: "POST",
      body: formdata
    })
      .then(function(result) {
    ...
    console.log("result output" ,paymentIntentJson ); 
