								...
								<div class="card-body p-1">
  									<form action="" method="post" id="form_data" name="form_data" class="form form-horizontal">
										<div class="form-body">
  											<div class="row">
												...
												<div class="col-md-6 col-sm-12">
													<div class="form-group row">
														...
														<div class="col-md-8">
                                                        	<input type="password" id="old_password" name="old_password" placeholder="Current Password" class="form-control"/>
 														</div>
													</div>
												</div>
												<div class="col-md-6 col-sm-12">
     										...
     										<div class="row">
												<div class="col-md-12">
 													<button type="submit" id="form_btn" name="form_btn" class="btn btn-primary btn-sm common-action-btn pull-right" onclick="form_common_data_validation('<?php echo base64_encode(5);?>')"> Update</button>
												</div>
											</div>
   										</div>
 									</form>
